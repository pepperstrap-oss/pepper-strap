    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        <p className="text-xs text-gray-400 mb-2">
          Tambahkan {RECOMMENDED_MIN}-{MAX_PHOTOS} foto agar pembeli bisa lihat detail strap dari berbagai sisi. Foto pertama jadi foto sampul.
        </p>
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-800 bg-white resize-none"
        />
      </div>
